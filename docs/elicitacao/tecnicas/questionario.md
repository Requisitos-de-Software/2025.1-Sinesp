...
O presente relatório tem como objetivo mapear o perfil dos usuários do aplicativo **GDF-Saúde** por meio de um instrumento de coleta quantitativa estruturado em forma de questionário. A metodologia adotada envolveu a elaboração de perguntas objetivas e discursivas relacionadas ao uso, experiência, percepção de segurança e sugestões de melhoria.

O questionário foi elaborado e divulgado por meio dos seguintes canais:
- A coleta foi feita via Google Forms, de forma anônima, respeitando a LGPD (Lei 13.709/2018).
- Disparados em grupos de WhatsApp que possuem servidores públicos usuários do app
- Divulgação espontânea entre colegas de trabalho e beneficiários do plano de saúde
...
|------|-----------------------------------------------------------------------------------------------------------|------------|
| RF01 | Permitir acesso rápido e estável à carteirinha digital                                                    | Alta       |
| RF02 | Exibir extrato financeiro atualizado diariamente                                                          | Alta       |
| RF03 | Listar rede credenciada com filtro por região, especialidade e tipo de atendimento                        | Alta       |
| RF04 | Mostrar histórico de consultas, exames e coparticipações                                                  | Alta       |
| RF05 | Permitir visualização dos valores a serem cobrados no mês                                                | Média      |
| RF06 | Habilitar notificações personalizadas por tipo (importantes, lembretes etc.)                             | Média      |
| RF07 | Adicionar consulta à rede odontológica                                                                    | Baixa      |
| RF08 | Oferecer ferramenta de busca por especialidade em determinada localidade                                 | Alta       |
| RF09 | Visualizar status de autorizações e solicitações médicas em tempo real                                   | Média      |
...
|-------|----------------------------------------------------------------------------------------------------------|------------|
| RNF01 | O aplicativo deve apresentar **alta disponibilidade** (mínimo de 99% uptime)                             | Alta       |
| RNF02 | A interface deve ser **intuitiva, acessível e responsiva** em smartphones Android e iOS                 | Alta       |
| RNF03 | O tempo de resposta das ações não deve ultrapassar 2 segundos                                            | Alta       |
| RNF04 | As informações exibidas devem ser **claras, completas e atualizadas em tempo real**                     | Alta       |
| RNF05 | O app deve ser compatível com leitores de tela (acessibilidade digital)                                  | Média      |
| RNF06 | A segurança das informações do usuário deve seguir os padrões da LGPD                                    | Alta       |
| RNF07 | O layout deve ser consistente com o portal oficial do plano                                              | Baixa      |
| RNF08 | As notificações devem ser configuráveis pelo usuário (frequência, tipo)
...
<p align="center">
  <img src="..\..\assets\inas.png" alt="10" width="500"/>
</p>
...
<p align="center">
  <img src="..\..\assets\ja-utilizou.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\01.png" alt="01" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\02.png" alt="02" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\03.png" alt="03" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\04.png" alt="04" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\05.png" alt="05" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\06.png" alt="06" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\07.png" alt="07" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\08.png" alt="08" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\09.png" alt="09" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\10.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\12.png" alt="11" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\13.png" alt="12" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\14.png" alt="13" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\15.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\16.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\18.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\19.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\20.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\21.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\Porque-nunca-utilizou.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
...
<p align="center">
  <img src="..\..\assets\lgpd.png" alt="10" width="500"/>
</p>
<p style="text-align: center; font-size: 16px;">
  Fonte: <a href="https://github.com/LucasAlves71">Lucas Alves</a>, <a href="https://github.com/bolzanMGB">Othavio Bolzan</a> e <a href="https://github.com/kalebmacedo">Kaleb Macedo</a>
</p>
