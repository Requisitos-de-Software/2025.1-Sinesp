...
|--------|-------------------------------------------------------------------------------------------------------|---------|--------------|
| RF01   | O sistema deve permitir ao usuário avaliar uma clínica após o atendimento.                            | GF01    |              |
| RF02   | O sistema deve notificar o usuário sobre retornos médicos pendentes.                                  | GF02    |              |
| RF03   | O sistema deve notificar o usuário sobre abertura de agenda e cancelamentos de horários de interesse. | GF03    |              |
| RF04   | O sistema deve exibir os exames solicitados e associar aos respectivos retornos médicos.              | GF04    |              |
| RF05   | O sistema deve divulgar informações sobre novas funcionalidades no aplicativo.                        | GF05    |              |
| RF06   | O sistema deve permitir que o usuário favorite horários de consulta desejados.                        | GF06    |              |
| RF07   | O sistema deve alertar o usuário caso algum horário favorito fique disponível por desistência.        | GF07    |              |
| RF08   | O sistema deve permitir ao usuário visualizar um histórico de consultas e exames realizados.          | GF08    |              |
| RF09   | O sistema deve oferecer um canal para o usuário enviar feedback sobre atendimentos.                   | GF09    |              |
| RF10   | O sistema deve exibir notificações sobre prazos importantes relacionados a consultas e exames.        | GF10    |              |
