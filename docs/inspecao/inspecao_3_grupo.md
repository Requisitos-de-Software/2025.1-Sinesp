...
| 5 | Os requisitos são não funcionais? | [Othavio Bolzan](https://github.com/bolzanMGB) | [Isaque Camargos](https://github.com/isaqzin), [Yzabella Miranda](https://github.com/redjsun) | <input type="checkbox"> Conforme |
...
Segue abaixo a gravação da inspeção da entrega 3, realizada no dia ** aaaaa**:
